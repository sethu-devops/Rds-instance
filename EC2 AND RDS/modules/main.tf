...
module "cloudwatch" {
  source = "./cloudwatch_alarm.tf"
  log_group_name = "t2s-jenkins-server-log-group"
  log_stream_name = "t2s-jenkins-server-log-stream"
  alarm_name = "t2s-jenkins-server-alarm"
  instance_id = "i-0cc4be2c28f4199fc"
